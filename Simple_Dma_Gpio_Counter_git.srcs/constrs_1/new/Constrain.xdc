...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {led_pin}];  # "JB1"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN T22 [get_ports {q}];  # "LD0"
...
#set_property PACKAGE_PIN U14 [get_ports {y}];  # "LD7"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {enable_0}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {clk}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {rst_n}];  # "SW2"
