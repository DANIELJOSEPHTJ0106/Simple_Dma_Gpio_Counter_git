...
#
# Simple_Dma_Gpio_Counter_git.tcl: Tcl script for re-creating project 'Simple_Dma_Gpio_Counter_git'
#
# Generated by Vivado on Fri May 29 11:05:41 +0530 2026
...
#
# 1. This project restoration tcl script (Simple_Dma_Gpio_Counter_git.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Admin/Desktop/RFMW/Projects/Simple_Dma_Gpio_Counter_git/Simple_Dma_Gpio_Counter_git.srcs/sources_1/new/axis_upcounter32.v"
#    "C:/Users/Admin/Desktop/RFMW/Projects/Simple_Dma_Gpio_Counter_git/Simple_Dma_Gpio_Counter_git.srcs/constrs_1/new/Constrain.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Simple_Dma_Gpio_Counter_git.srcs/sources_1/new/axis_upcounter32.v"]"\
 "[file normalize "$origin_dir/Simple_Dma_Gpio_Counter_git.srcs/constrs_1/new/Constrain.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "Simple_Dma_Gpio_Counter_git"
...
set script_file "Simple_Dma_Gpio_Counter_git.tcl"
...
set file "new/axis_upcounter32.v"
...
set file "[file normalize "$origin_dir/Simple_Dma_Gpio_Counter_git.srcs/constrs_1/new/Constrain.xdc"]"
...
if { [get_files axis_upcounter32.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Admin/Desktop/RFMW/Projects/Simple_Dma_Gpio_Counter_git/Simple_Dma_Gpio_Counter_git.srcs/sources_1/new/axis_upcounter32.v
}
...
\
  ...
  # Create instance: axis_upcounter32_0, and set properties
  set block_name axis_upcounter32
  set block_cell_name axis_upcounter32_0
  if { [catch {set axis_upcounter32_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_upcounter32_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axis_upcounter32_0_m_axis [get_bd_intf_pins axis_upcounter32_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_net -net enable_0_1 [get_bd_ports enable_0] [get_bd_pins axis_upcounter32_0/enable]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axis_upcounter32_0/aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axis_upcounter32_0/aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins axis_upcounter32_0/packet_size]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.515586",
   "Default View_TopLeft":"-109,-192",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2150 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2150 -y 330 -defaultsOSRD
preplace port port-id_enable_0 -pg 1 -lvl 0 -x 0 -y 350 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -x 1890 -y 390 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -x 1180 -y 380 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 5 -x 1510 -y 370 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 5 -x 1510 -y 520 -defaultsOSRD
preplace inst axis_upcounter32_0 -pg 1 -lvl 2 -x 530 -y 340 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 200 -y 410 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 240 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 850 -y 120 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 3 -x 850 -y 360 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 30 340 380 430 680 440 1000 480 1350 460 1650 530 2120
preplace netloc enable_0_1 1 0 2 NJ 350 NJ
preplace netloc xlconstant_0_dout 1 1 1 390J 370n
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 20 140 NJ 140 670J 250 NJ 250 NJ 250 NJ 250 2130
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 370 250 690 450 1010 490 1370
preplace netloc xlconcat_0_dout 1 5 1 1660J 430n
preplace netloc axi_dma_0_s2mm_introut 1 4 1 1360 400n
preplace netloc processing_system7_0_DDR 1 6 1 NJ 310
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ 330
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 N 360
preplace netloc processing_system7_0_M_AXI_GP0 1 2 5 700 240 NJ 240 NJ 240 NJ 240 2120
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 1000 120n
preplace netloc smartconnect_0_M00_AXI 1 5 1 N 370
preplace netloc axis_upcounter32_0_m_axis 1 2 1 N 340
preplace netloc axis_data_fifo_0_M_AXIS 1 3 1 N 360
levelinfo -pg 1 0 200 530 850 1180 1510 1890 2150
pagesize -pg 1 -db -bbox -sgen -110 0 2270 580
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Simple_Dma_Gpio_Counter_git.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Simple_Dma_Gpio_Counter_git.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/Simple_Dma_Gpio_Counter_git.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Simple_Dma_Gpio_Counter_git.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
